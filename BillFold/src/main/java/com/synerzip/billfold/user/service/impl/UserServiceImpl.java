...
public class UserServiceImpl implements UserService{
	...
	/* (non-Javadoc)
	 * @see com.synerzip.billfold.user.service.UserService#saveOrUpdateUserProfile(com.synerzip.billfold.user.dto.UserProfileDTO)
	 */
	@Override
	@Transactional
	...
	/* (non-Javadoc)
	 * @see com.synerzip.billfold.user.service.UserService#sendVerificationCode(com.synerzip.billfold.user.dto.VerificationCodeDTO)
	 */
	@Override
	@Transactional
	public Boolean sendVerificationCode(VerificationCodeDTO vdto) {
		...
		String smscode = smsUtil.sendActivationCodeSMS(vdto.getMobileNumber());
		code.setVerificationCode(smscode);
		LinkPhoneVerificationCode linkcode = phoneverificationRepo.findByPhoneNumber(vdto.getMobileNumber());
		if(linkcode==null){
	...
	/* (non-Javadoc)
	 * @see com.synerzip.billfold.user.service.UserService#verifyPhoneNumber(com.synerzip.billfold.user.dto.VerificationCodeDTO)
	 */
	@Override
	public Boolean verifyPhoneNumber(VerificationCodeDTO vdto) {
		// TODO Auto-generated method stub
			LinkPhoneVerificationCode linkcode = phoneverificationRepo.findByPhoneNumber(vdto.getMobileNumber());
			if(linkcode!=null){
				if(linkcode.getVerificationCode().equals(vdto.getVerificationCode()))
					return true;
			}
			return false;
	}
